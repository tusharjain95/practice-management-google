...
export function generateRosterPdfBuffer(staffName, date, data) {
  return new Promise((resolve, reject) => {
    try {
      // --- INTERCEPT PDFKit Font Init to Avoid Helvetica.afm Load Error on Next.js/Vercel ---
      ...
      // Restore original prototype function immediately so other usage isn't permanently modified
