  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      kpis.forEach((kpi, idx) => {
        ...
        // Value
        doc.fillColor(kpi.color).fontSize(20).font('Helvetica-Bold').text(String(kpi.value), x + 10, kpiY + 15, { width: boxWidth - 20, align: 'center' });
        // Label
        doc.fillColor(LIGHT_TEXT).fontSize(8).font('Helvetica').text(kpi.label, x + 5, kpiY + 45, { width: boxWidth - 10, align: 'center' });
      });
