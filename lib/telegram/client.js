...
const PROVIDER = process.env.TELEGRAM_PROVIDER || 'mock';
...
• <b>Due Today:</b> ${performanceStats.dueTodayCount || 0}

<i>Check the attached PDF for a complete breakdown and priority tasks. Let's make today even more productive!</i>
  `.trim();
